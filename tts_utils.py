...
def voice_recorder_component_html(textarea_key: str) -> str:
    """Full HTML page — records voice and writes transcript to URL query params for Streamlit to read."""
    return f"""
<!DOCTYPE html>
<html>
<head>
        ...
        startBtn.addEventListener('click', function() {{
            ...
            recognition.onerror = function(e) {{
                if (e.error === 'no-speech') {{
                    statusEl.textContent = 'No speech detected. Click Start and speak clearly.';
                }} else {{
